...
- Echobloom Canopy's existing `echobloom-canopy-battle-v1.png` is certified as the low-camera extension of the walking board. The spiral-root tree, blue bell flowers, glowing pool, amber caretaker lantern, vine bridge, moss-root floor, and translucent leaves preserve exact-place continuity.
...
- Lumenveil Grove's existing `lumenveil-grove-battle-v1.png` is certified as the low-camera extension of the walking board. The luminous root arch, giant blue mushrooms, mirror pool, violet spore pods, amber caretaker lantern, sanctuary waystone, and glowmoss ground preserve exact-place continuity.
...
- Tidegate Causeway's existing `tidegate-causeway-painted-v1.png` and `tidegate-causeway-battle-v1.png` are certified as a high-board/low-camera pair. The rune arch and hanging lantern, stepping stones, sluice gate, rope-post causeway, reed beds, and blue-marked waystones preserve exact-place continuity across exploration and battle.
...
- Redglass's existing `redglass-saltpan-battle-v1.png` remains the approved low-camera target. The cracked red mineral sheet, pink salt polygons, blue-white mirage seams, caretaker shade canopy, sanctuary waystone, red crystal clusters, and half-swallowed ruin arches recur without unrelated arena additions. The V1 walking painting was reopened on 2026-08-02 because its visible horizon misses the locked top-down exploration camera; regenerate that side of the pair without changing these landmarks.
...
- `Thunderhead Mesa` now uses the corrected imagegen storm-desert board `thunderhead-mesa-painted-v2.png`. The former v1 showed a large horizon and failed the exploration camera gate; v2 uses a 55-degree horizon-free view with substantially more readable ground.
- Thunderhead Mesa's `thunderhead-mesa-battle-v1.png` remains the certified low-camera counterpart. The lightning-rod array, twin wind-carved towers, blue electrical ground veins, dry stormgrass, blue storm vane, sanctuary waystone, and orange sandstone route preserve exact-place continuity.
...
- Magmaheart Caldera's existing `magmaheart-caldera-battle-v1.png` is certified as the low-camera extension of the walking board. The heart-shaped magma vent, heat-cage lantern, obsidian rib arch, magma rivers, red crystals, black basalt lanes, and carved waystones preserve exact-place continuity.
...
- `Basalt Bloom Caldera` now uses `basalt-bloom-caldera-painted-v2.png`, a corrected all-ground high exploration board. The former v1 painting is retained for rollback but is not production-active because its orange sky band failed the no-horizon gate.
- Basalt Bloom's existing `basalt-bloom-caldera-battle-v1.png` is certified as the low-camera extension of the corrected walking board. The central red crystal bloom, three steam cages, loop route, basalt columns, ember flowers, heat vines, sanctuary waystone, stairs, and lava fissures preserve exact-place continuity.
...
- `Cinderlake Basin` keeps its certified `cinderlake-basin-painted-v1.png` high exploration board. The frame is entirely terrain and molten lake, with no sky or horizon, and its continuous basalt route plus stepping stones remain readable for traversal.
- Cinderlake's existing `cinderlake-basin-battle-v1.png` is certified as the low-camera extension of the walking board. The broad lava lake, paired obsidian ribs, hanging heat lantern, carved waystone, red crystals, and cracked basalt stage preserve exact-place continuity.
...
- `Cindershore Strand` keeps its certified `cindershore-strand-painted-v1.png` high exploration board. The frame is entirely black-glass beach, habitat ground, and molten shoreline with no sky or horizon, while its main traversal lane, tide pools, and shoreline boundary remain readable.
- Cindershore's existing `cindershore-strand-battle-v1.png` is certified as the low-camera extension of the walking board. The molten surf, black-glass sand, basalt tide pools, fossil-root driftwood arch, heatglass shells, caretaker lantern, and sanctuary marker preserve exact-place continuity.
- Briar Gym now uses `briar-gym-painted-v2.png`, extending the legacy square board into the required 1536x1024 landscape canvas without lowering its camera. The green carpet, practice ring, bench lane, chair dais, arched window, paired banners, and mossed stone remain paired with `briar-gym-battle-v2.png`.
- Lantern Nursery now uses `lantern-nursery-painted-v2.png`, extending the legacy square board into the required 1536x1024 landscape canvas without lowering its camera. The teal greenhouse, care canopy, moss ring, habitat pens, hollow logs, cold frames, reeds, and split paths remain paired with `lantern-nursery-battle-v2.png`.
...
- Asterwake Shoals now uses `asterwake-shoals-battle-v2.png`, certified at 10/10 as the daylight low-camera extension of the walking board. The starfish driftwood arch, five-point tidepool, caretaker lantern, sanctuary waystone, tidegrass, shell beds, black rocks, and soft coastal daylight preserve exact-place and lighting continuity.
